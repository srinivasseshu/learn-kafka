...
package com.learn.kafka.examples.simplecounter.producer;
...
public class SimpleCounter {
    ...
    /*
     *   ./run_params_simplecounter.sh localhost:9092 first old async 500 10
     *   ./run_params_simplecounter.sh localhost:9092 first old sync 500 10
     *   ./run_params_simplecounter.sh localhost:9092 first new async 500 10
     *   ./run_params_simplecounter.sh localhost:9092 first new sync 500 10
     */
